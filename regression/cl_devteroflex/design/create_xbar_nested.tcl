...
set axi_pcis_xbar [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect axi_pcis_xbar ]
set_property -dict [ list \
...
# Internal
connect_bd_intf_net -intf_net S_PCIS_DRAM_AXI_IO [get_bd_intf_pins axi_pcis_xbar/M00_AXI] [get_bd_intf_pins axi_dram_xbar/S00_AXI]

# Create port connections
connect_bd_net -net ARESETN_WIRE [get_bd_ports ARESETN] \
  [get_bd_pins axi_pcis_xbar/ARESETN]     \
  [get_bd_pins axi_pcis_xbar/M00_ARESETN] \
  [get_bd_pins axi_pcis_xbar/M01_ARESETN] \
  [get_bd_pins axi_pcis_xbar/S00_ARESETN] \
...
connect_bd_net -net ACLK_WIRE [get_bd_ports ACLK] \
  ...
  [get_bd_pins axi_pcis_xbar/ACLK]     \
  [get_bd_pins axi_pcis_xbar/M00_ACLK] \
  [get_bd_pins axi_pcis_xbar/M01_ACLK] \
  [get_bd_pins axi_pcis_xbar/S00_ACLK]
